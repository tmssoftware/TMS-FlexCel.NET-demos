...
- As formerly said, use regular expressions with care. Sometimes they
  ...
  function to do a complex transformation. (See the [User Defined Functions](https://doc.tmssoftware.com/flexcel/net/samples/vb/netframework/reports/user-defined-functions/index.html) example)
