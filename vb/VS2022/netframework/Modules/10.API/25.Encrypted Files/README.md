...
- Concepts on this demo are similar to the ones shown in [Encryption And Subtotals](https://doc.tmssoftware.com/flexcel/net/samples/vb/netframework/reports/encryption-and-subtotals/index.html) example, but are repeated here so you can see them
