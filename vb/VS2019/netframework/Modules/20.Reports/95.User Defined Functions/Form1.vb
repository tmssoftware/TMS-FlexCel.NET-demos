...
Namespace UserDefinedFunctions
	...
	Friend Class OrdersImp
		Inherits TFlexCelUserFunction

		Private OrdersDv As DataView

		Public Sub New(ByVal OrdersTable As DataTable)
		...
		Public Overrides Function Evaluate(ByVal parameters() As Object) As Object
			...
			Dim Count As Integer = OrdersDv.FindRows(parameters).Length
			If Count > 0 Then
				Return Count
			Else
				Return Nothing
