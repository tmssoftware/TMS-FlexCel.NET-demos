...
Namespace GenericReports
	...
	Partial Public Class mainForm
		...
		Private Sub btnOpenconnection_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOpenConnection.Click
			...
			Dim ConfigFile As String = DataPath & "GenericReports.udl"
		...
		Private Sub Export(ByVal SQL As String, ByRef DataPath As String)
			...
			If Not File.Exists(DataPath & "Generic Reports.template.xls") Then 'When on design mode, search for the template 2 folders up.
