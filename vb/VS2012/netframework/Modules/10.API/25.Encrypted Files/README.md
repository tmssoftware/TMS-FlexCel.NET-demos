...
- Concepts on this demo are similar to the ones shown in [Encryption And Subtotals](https://download.tmssoftware.com/flexcel/doc/net/samples/vb/netframework/reports/encryption-and-subtotals/index.html) example, but are repeated here so you can see them
