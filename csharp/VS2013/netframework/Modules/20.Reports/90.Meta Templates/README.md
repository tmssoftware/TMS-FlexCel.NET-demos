...
generic reports, besides what is shown in the [Generic Reports](https://doc.tmssoftware.com/flexcel/net/samples/csharp/netframework/reports/generic-reports/index.html) example.
