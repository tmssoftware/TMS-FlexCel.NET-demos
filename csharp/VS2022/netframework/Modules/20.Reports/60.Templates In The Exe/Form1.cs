...
namespace TemplatesInTheExe
{
    ...
    public partial class mainForm: System.Windows.Forms.Form
    {
        ...
        public void AutoRun()
        {
            using (FlexCelReport ordersReport = SharedData.CreateReport())
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    using (Stream InStream = a.GetManifestResourceStream("TemplatesInTheExe.Templates.Templates In The Exe.template.xls"))
                    {
        ...
        {
            Assembly a = Assembly.GetExecutingAssembly();
            using (Stream InStream = a.GetManifestResourceStream("TemplatesInTheExe.Templates." + e.FileName))
            {
